    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(logged){
           ArrayList<Purchase> history = new ArrayList();
            ...
            try {
                history = PurchaseDAO.getInstance().getPurchaseHistory( request.getSession().getAttribute("USER").toString());
            ...
            request.getRequestDispatcher("PreviousPurchasesJSP.jsp").forward(request, response);
